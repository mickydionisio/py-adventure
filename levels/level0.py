...
# Starting Room 
# Bedroom properties
bedroom.description = "You are in your bedroom.  There is a door to the EAST, piles of dirty clothes, and a DESK with random stuff on it."
